...
export interface ExtendedEnemy {
  ...
  update: (deltaTime: number, extendedEnemy?: ExtendedEnemy) => void
  draw: (context: CanvasRenderingContext2D | null, extendedEnemy?: ExtendedEnemy) => void
}
...
export class Enemy {
  ...
  draw(context: CanvasRenderingContext2D | null, extendedEnemy?: ExtendedEnemy) {
    ...
    if (extendedEnemy.game.debug) {
      context.strokeRect(extendedEnemy.x, extendedEnemy.y, extendedEnemy.width, extendedEnemy.height)
    }
    context.drawImage(
      extendedEnemy.image,
      this.frameX * extendedEnemy.width,
      0,
      extendedEnemy.width,
      extendedEnemy.height,
      extendedEnemy.x,
      extendedEnemy.y,
      extendedEnemy.width,
      extendedEnemy.height
